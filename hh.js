...
export function useFileSystem() {
  ...
  var update = function update() {
    if (!current) return;
    getChildren(current).then(function (_children) {
      setChildren(_toConsumableArray(_children));
    });
  };
  useMemo(
    function () {
  ...
  var fileSystem = useMemo(
    function () {
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1)
                switch ((_context.prev = _context.next)) {
                  case 0:
                    _context.next = 2;
                    return removeFile(current, name);
                  case 2:
                    update();
                  case 3:
                  case 'end':
      ...
      function _create() {
        _create = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(
            function _callee2(name, type, data) {
                ...
                while (1)
                  switch ((_context2.prev = _context2.next)) {
                    case 0:
                      ...
                      _context2.next = 3;
                      return createFile(current, name, data);
                    case 3:
                      _context2.next = 7;
                      break;
                    case 5:
                      _context2.next = 7;
                      return createDirectory(current, name);
                    case 7:
                      update();
                    case 8:
                    case 'end':
      ...
      function enterDirectory(_x5) {
        return _enterDirectory.apply(this, arguments);
      }
      function _enterDirectory() {
        _enterDirectory = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee3(name) {
            return _regeneratorRuntime().wrap(function _callee3$(_context3) {
              while (1)
                switch ((_context3.prev = _context3.next)) {
                  case 0:
                    getHandle(current, name).then(function (res) {
  ...
  useEffect(function () {
    window.navigator.storage.getDirectory().then(function (res) {
      setCurrent(res);
      root.current = res;
    });
  }, []);
