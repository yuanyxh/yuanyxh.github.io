...
author: yuanyxh
imageUrl: https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Pro_Git_reading_comprehension_how_to_achieve_git-logo.webp
...
![git 工作示例的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Pro_Git_reading_comprehension_how_to_achieve_git-01.webp)
...
![head 的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Pro_Git_reading_comprehension_how_to_achieve_git-02.webp)

这表明当前分支是 `.git/refs/heads/master`，查看对应的文件内容：

![分支指向的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Pro_Git_reading_comprehension_how_to_achieve_git-03.webp)

这是一个 40 位的指纹信息，引用到具体的文件；Git 以 40 位指纹的前两位作为目录名，剩余的 38 位作为文件名存储文件快照，这些文件都存放在 `.git/objects` 中：

![指纹信息的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Pro_Git_reading_comprehension_how_to_achieve_git-04.webp)

Git 使用 zlib 的 `Deflate` 算法压缩内容，需要解压才能看到有意义的文件内容，使用 nodejs 解压上面的 `1d/7f00bcdea10b04ceab0d243d181f09a971bcd0` 文件：

![压缩信息解压的代码图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Pro_Git_reading_comprehension_how_to_achieve_git-05.webp)

得到的内容如下：

![压缩信息解压后的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Pro_Git_reading_comprehension_how_to_achieve_git-06.webp)
...
![tree 信息的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Pro_Git_reading_comprehension_how_to_achieve_git-07.webp)
...
![blob 信息的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Pro_Git_reading_comprehension_how_to_achieve_git-08.webp)
...
![blob 展示信息的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Pro_Git_reading_comprehension_how_to_achieve_git-09.webp)

但其实中间间隔了一个不可见字符 `\x00`：

![不可见字符的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Pro_Git_reading_comprehension_how_to_achieve_git-10.webp)
...
![关系展示的图片3](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Pro_Git_reading_comprehension_how_to_achieve_git-17.webp)
...
![多出来的文件的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Pro_Git_reading_comprehension_how_to_achieve_git-18.webp)

![多出来的文件的图片2](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Pro_Git_reading_comprehension_how_to_achieve_git-19.webp)

![多出来的文件的图片3](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Pro_Git_reading_comprehension_how_to_achieve_git-20.webp)
