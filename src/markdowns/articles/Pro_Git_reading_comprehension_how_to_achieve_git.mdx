...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/b10acca5ec70f4f0.webp" width={500} height={222} alt='git 工作示例的图片' />
...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/883c1606755f79f4.webp" width={381} height={162} alt='head 的图片' />

这表明当前分支是 `.git/refs/heads/master`，查看对应的文件内容：

<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/27e0c900cd4722b5.webp" width={412} height={127} alt='分支指向的图片' />

这是一个 40 位的指纹信息，引用到具体的文件；Git 以 40 位指纹的前两位作为目录名，剩余的 38 位作为文件名存储文件快照，这些文件都存放在 `.git/objects` 中：

<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/2e6e083b2edfe102.webp" width={699} height={398} alt='指纹信息的图片' />

Git 使用 zlib 的 `Deflate` 算法压缩内容，需要解压才能看到有意义的文件内容，使用 nodejs 解压上面的 `1d/7f00bcdea10b04ceab0d243d181f09a971bcd0` 文件：

<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/b0df9d2a149ca14b.webp" width={796} height={294} alt='压缩信息解压的代码图片' />

得到的内容如下：

<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/07f08684c2cc3d3c.webp" width={438} height={100} alt='压缩信息解压后的图片' />
...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/776bfa9f90cb333f.webp" width={411} height={68} alt='tree 信息的图片' />
...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/6c2fabd0668fb9e4.webp" width={354} height={35} alt='blob 信息的图片' />
...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/9714e8176a1ce2c8.webp" width={437} height={83} alt='blob 展示信息的图片' />

但其实中间间隔了一个不可见字符 `\x00`：

<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/151adb38028f6a4d.webp" width={826} height={462} alt='不可见字符的图片' />
...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/2221866ba2c431b5.webp" width={445} height={310} alt='分支展示的图片' />

<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/fce2a9a0da20f2c2.webp" width={392} height={310} alt='分支展示的图片2' />

<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/4cc64f4f3f73bcb5.webp" width={500} height={287} alt='分支展示的图片3' />

commit 对象：

<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/77f61e9c7379af83.webp" width={500} height={338} alt='commit 展示的图片' />

<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/174c1b8cf2be4e51.webp" width={500} height={223} alt='commit 展示的图片2' />

<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/9ac0c83c065057f7.webp" width={500} height={251} alt='commit 展示的图片3' />
...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/5470b6dfd363e21d.webp" width={500} height={339} alt='关系展示的图片3' />
...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/1ad946da5c379cbf.webp" width={699} height={379} alt='多出来的文件的图片' />

<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/3cc9c37a033dc7a7.webp" width={699} height={386} alt='多出来的文件的图片2' />

<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/55fb84a618a643e0.webp" width={699} height={385} alt='多出来的文件的图片3' />
