...
author: yuanyxh
imageUrl: https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/commonmark.js_source_block_parser-logo.webp
...
- 分支 2：剩余文本内容是代码块、HTML 块的内容，或是一个新的段落。
  ...
  ![closeUnmatchedBlocks](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/commonmark.js_source_block_parser-01.webp)
