...
author: yuanyxh
imageUrl: https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/what_is_gif-logo.webp
...
![示例图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/what_is_gif-01.webp)
...
![文件头图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/what_is_gif-02.webp)

### LogicScreenDescriptor

紧随 Header 之后的是 LogicScreenDescriptor，这里包含了整个 gif 文件的全局信息，固定 7 个字节，如下图：

![全局信息的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/what_is_gif-03.webp)
...
![全局色表的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/what_is_gif-04.webp)
...
![评论扩展的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/what_is_gif-05.webp)

### Graphic-Control-Extension

图形控制扩展，顾名思义包含了可以控制图形展示的信息，它的作用范围是此块出现后的第一个 `Image` 或 `Plain Text Extension`，固定 7 字节，其中 `0x21, 0xf9` 占用两个字节。如下图：

![图形控制扩展的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/what_is_gif-06.webp)
...
![图像描述符的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/what_is_gif-07.webp)
...
![纯文本扩展的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/what_is_gif-08.webp)
...
![应用程序扩展的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/what_is_gif-09.webp)
...
![rgb 收集的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/what_is_gif-10.webp)
...
![rgb 树展示的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/what_is_gif-11.webp)

![rgb 树展示的图片2](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/what_is_gif-12.webp)

上面的数据只是最低位发生了变化，可以看到结果确实是将它们归纳到了同一颗树中，这些颜色如下图：

![rgb 同一颗树颜色的展示图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/what_is_gif-13.webp)
...
![gif 展示的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/what_is_gif-14.webp)
...
![gif 播放器展示的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/what_is_gif-15.webp)
