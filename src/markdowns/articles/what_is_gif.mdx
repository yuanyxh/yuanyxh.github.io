...
author: yuanyxh
imageUrl: https://qkc148.bvimg.com/18470/5fb84fd5087780ea.jpg
...
<Image url="https://qkc148.bvimg.com/18470/6c9b329e24d97c4e.gif" width={320} height={200} alt='示例图片' />
...
<Image url="https://qkc148.bvimg.com/18470/302f3fa33391f95d.png" width={1280} height={704} alt='文件头图片' />

### LogicScreenDescriptor

紧随 Header 之后的是 LogicScreenDescriptor，这里包含了整个 gif 文件的全局信息，固定 7 个字节，如下图：

<Image url="https://qkc148.bvimg.com/18470/e4b8d54aaef9e533.png" width={1282} height={728} alt='全局信息的图片' />
...
<Image url="https://qkc148.bvimg.com/18470/a2b2997771b78520.png" width={1280} height={704} alt='全局色表的图片' />
...
<Image url="https://qkc148.bvimg.com/18470/f1671570f29ae4e0.png" width={1280} height={704} alt='评论扩展的图片' />

### Graphic-Control-Extension

图形控制扩展，顾名思义包含了可以控制图形展示的信息，它的作用范围是此块出现后的第一个 `Image` 或 `Plain Text Extension`，固定 7 字节，其中 `0x21, 0xf9` 占用两个字节。如下图：

<Image url="https://qkc148.bvimg.com/18470/fa884d776fcc7469.png" width={1282} height={728} alt='图形控制扩展的图片' />
...
<Image url="https://qkc148.bvimg.com/18470/02129d069ddfbe62.png" width={1280} height={704} alt='图像描述符的图片' />
...
<Image url="https://qkc148.bvimg.com/18470/ea76a08f203542ee.png" width={1280} height={704} alt='纯文本扩展的图片' />
...
<Image url="https://qkc148.bvimg.com/18470/050d4872a4c38fc9.png" width={1280} height={704} alt='应用程序扩展的图片' />
...
<Image url="https://qkc148.bvimg.com/18470/63c84f91f8d0ca8b.png" width={339} height={99} alt='rgb 收集的图片' />
...
<Image url="https://qkc148.bvimg.com/18470/7f4a65aacc959abb.png" width={341} height={1144} alt='rgb 树展示的图片' />

<Image url="https://qkc148.bvimg.com/18470/723268bd85db31ee.png" width={1366} height={360} alt='rgb 树展示的图片2' />

上面的数据只是最低位发生了变化，可以看到结果确实是将它们归纳到了同一颗树中，这些颜色如下图：

<Image url="https://qkc148.bvimg.com/18470/2a55b6b16180a7b5.png" width={1366} height={279} alt='rgb 同一颗树颜色的展示图片' />
...
<Image url="https://qkc148.bvimg.com/18470/103cb89dd2180c85.gif" width={640} height={360} alt='gif 展示的图片' />
...
<Image url="https://qkc148.bvimg.com/18470/5b90ec5020e61cf0.png" width={1069} height={551} alt='gif 播放器展示的图片' />
