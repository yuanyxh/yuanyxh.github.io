...
author: yuanyxh
imageUrl: https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/前端仔的一次运维实践-logo.webp
description: 排查服务器异常流量原因，过滤日志封禁固定网段 ip，测试并完善多种动态限流策略，实现多级控制与简易人机校验逻辑。
...
![外网出带宽使用率](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/前端仔的一次运维实践-01.png)
