...
author: yuanyxh
imageUrl: https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/59816849ca089366.webp
description: 从解析一个 PDF 开始，探索 JS 中处理二进制数据的方式，展望未来 Web 应用程序的形式。
keywords: pdf, binrary, file system, xref, trailer, pdf parse
---
...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/95f1b88a15e8c323.webp" width={921} height={606} alt='xref 展示的图片' />
...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/03a07edbadaa86f0.webp" width={1341} height={606} alt='Trailer 展示的图片' />
...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/4b0c74fa6036826b.webp" width={1341} height={606} alt='startxref 展示的图片' />
...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/86f5b2a69e33d735.webp" width={1366} height={475} alt='chrome 字节打印展示的图片' />
...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/534beb7e907301f6.webp" width={1366} height={307} alt='trailer 对象展示的图片' />
...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/32bbff9fd2f5fd12.webp" width={1366} height={475} alt='Xref 对象展示的图片' />
...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/29869cc5c4aecb20.webp" width={1341} height={606} alt='文档目录展示的图片' />

其中，`Type` 和 `Pages` 是必须的，Type 必须是 Catalog，表示这是一个文档目录；而 Pages 引用了 PDF 中页面树的根节点对象。

Pages 根节点对象的基本格式如下：

<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/6aead18de095133b.webp" width={1341} height={606} alt='Pages 展示的图片' />
...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/e4f6a1b07d5a002f.webp" width={1341} height={606} alt='page 基本信息展示的图片' />
...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/e4dd349250c0e963.webp" width={1341} height={606} alt='对象 7 基本信息展示的图片' />
...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/e6c51064da8cf25d.webp" width={1110} height={618} alt='解压后展示的图片' />
...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/e4ff342ba1e9d0d7.webp" width={946} height={601} alt='绘图指令展示的图片' />
...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/62cbcdf5d7218dc2.webp" width={946} height={601} alt='文本映射展示的图片' />

<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/9b17bc81bf0c3f2c.webp" width={1341} height={606} alt='文本映射展示的图片2' />

<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/a77d7139e241f7ef.webp" width={1341} height={606} alt='文本映射展示的图片3' />

解压图中 obj 13 的流数据后会得到类似下图的数据：

<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/6e9e76ea5bcab5b3.webp" width={946} height={601} alt='文本流展示的图片' />
...
<Image url="https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/89e4b3727ab2f321.webp" width={1366} height={625} alt='绘制 pdf 效果展示的图片' />
