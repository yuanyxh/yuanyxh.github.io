...
author: yuanyxh
imageUrl: https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-logo.webp
...
- 使用 Portaienr 面板以服务的形式部署它：
  ...
  1. 基本配置
     ...
     ![部署服务-步骤 1](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-01.png)

  2. 挂载主机目录，实现持久化

     ![部署服务-步骤 2](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-02.png)

  3. 配置异常策略，这里我们设置任意情况都需要重启，以保证服务可用，同时设置最大重试次数为 0（不限制）

     ![部署服务-步骤 3](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-03.png)

  4. 配置资源限制与部署策略，这里我们不限制其使用资源，然后只在 manager 节点上部署此服务

     ![部署服务-步骤 4](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-04.png)
...
![配置自定义 Docker registry](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-05.png)
...
1. 基本配置（WUD 容器默认端口应该是 3000）
   ...
   ![WUD 步骤-1](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-06.png)
...
3. 我们配置 WUD 专用的环境变量，以控制其内部行为：
   ...
   ![WUD 步骤-2](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-07.png)
...
![WUD 步骤-3](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-08.png)
...
![监控服务](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-09.png)
...
![Grafana 步骤-1](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-10.png)

设置为 Prometheus：

![Grafana 步骤-2](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-11.png)

这里需要配置公网 ip，然后进行测试保存，也可以进行更多配置：

![Grafana 步骤-3](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-12.png)

然后导入面板：

![Grafana 步骤-4](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-13.png)

我们导入 cadvisor（容器监控）的面板，id 为 14282（node_exporter（主机资源监控）为 1860）：

![Grafana 步骤-5](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-14.png)

现在可以查看各容器实例的资源占用情况：

![Grafana 步骤-6](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-15.png)
...
![部署测试服务](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-16.png)

添加 Labels 指示 WUD 观察镜像更新与自动升级：

![部署测试服务-02](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-17.png)

现在可以访问 ip +  端口查看效果：

![部署测试服务-03](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-18.png)
...
![测试服务](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-19.png)

> 我们可以免去手动编译镜像并推送更新的步骤，可以通过 git hook、webhook 等功能自动构建、测试，并推送更新。

测试通过！现在我们需要部署到正式环境，我们创建一个 Service：

![部署正式环境](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-21.png)

注意我们添加的 Labels，触发器包含了 `smtp.yjzt`，这是用于 SMTP 邮件服务器通知的，为此我们需要添加 WUD 的环境变量配置：

![修改 WUD 配置](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-20.png)
...
![QQ 通知](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/continuous_delivery_and_deployment-research_and_implementation-22.png)
