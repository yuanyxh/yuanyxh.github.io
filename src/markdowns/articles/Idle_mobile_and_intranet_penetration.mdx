...
author: yuanyxh
imageUrl: https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Idle_mobile_and_intranet_penetration-logo.webp
...
![termux 换源的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Idle_mobile_and_intranet_penetration-01.webp)

![termux 换源的图片2](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Idle_mobile_and_intranet_penetration-02.webp)
...
![termux 开启存储的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Idle_mobile_and_intranet_penetration-03.webp)

开启后通过 ls 命令列举根目录的文件夹会出现 storage：

![termux 开启存储后的文件列表图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Idle_mobile_and_intranet_penetration-04.webp)
...
![github frp 列表的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Idle_mobile_and_intranet_penetration-05.webp)
...
![文件列表的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Idle_mobile_and_intranet_penetration-06.webp)
...
![文件列表的图片2](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Idle_mobile_and_intranet_penetration-07.webp)
...
![github caddy 的列表图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Idle_mobile_and_intranet_penetration-08.webp)
...
![创建 caddy 密码的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Idle_mobile_and_intranet_penetration-09.webp)
...
![github rclone 的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Idle_mobile_and_intranet_penetration-10.webp)
...
![远程连接面板的图片](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/Idle_mobile_and_intranet_penetration-11.webp)
