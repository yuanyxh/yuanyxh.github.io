...
author: yuanyxh
imageUrl: https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/debugging_and_understanding_nodejs_modules-logo.webp
...
![image](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/debugging_and_understanding_nodejs_modules-01.webp)

新建 `/.vscode/launch.json` vscode 调试配置文件：

![image](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/debugging_and_understanding_nodejs_modules-02.webp)
...
![image](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/debugging_and_understanding_nodejs_modules-03.webp)

但是可以看到左下角列出来经过的全部程序，我们直接在首先启动的程序文件中打上断点：

![image](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/debugging_and_understanding_nodejs_modules-04.webp)

![image](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/debugging_and_understanding_nodejs_modules-05.webp)
...
![image](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/debugging_and_understanding_nodejs_modules-06.webp)
