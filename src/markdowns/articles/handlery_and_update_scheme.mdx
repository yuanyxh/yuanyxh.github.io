...
author: yuanyxh
imageUrl: https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/handlery_and_update_scheme-logo.webp
...
![image](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/handlery_and_update_scheme-01.webp)
...
![image](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/handlery_and_update_scheme-02.webp)
...
![image](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/handlery_and_update_scheme-03.webp)

可以通过 `responseStatus` 状态码判断是否加载成功：

![image](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/handlery_and_update_scheme-04.webp)
