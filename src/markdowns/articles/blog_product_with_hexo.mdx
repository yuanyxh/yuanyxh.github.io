---
title: 个人博客搭建 - 基于 Hexo + Next + Github
...
keywords: hexo, 个人博客, next 主题, github pages
---
...
<Image url='https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/0e2a1a239bc219de.webp' width={1366} height={625} alt='hexo_init_blog' />
...
<Image url='https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/9a468b2b731affad.webp' width={1366} height={625} alt='next 主题' />
...
<Image url='https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/46026a0a9acbe2ad.webp' width={1115} height={211} alt='解析 DNS' />
...
<Image url='https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/fb8d6ba8afa651bf.webp' width={1077} height={495} alt='Github 官方文档' />

设置解析后前往 仓库设置为自己的域名：Settings -> Pages

<Image url='https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/8b4afa23cced642e.webp' width={1092} height={552} alt='设置域名' />
...
<Image url='https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/e82c64e56b76f575.webp' width={936} height={211} alt='添加版权' />
