...
<Image url={'https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/29f35b549d849475.webp'} width={1089} height={408} />
...
<Image url={'https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/f2bc9721b3dba060.webp'} width={380} height={72} />

但内部的状态依然未变：

<Image url={'https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/e26431cdb387d382.webp'} width={517} height={139} />
...
<Image url={'https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/18859edd4a1cca9f.webp'} width={1920} height={527} />

React 实现了自己的合成事件系统，几乎所有的事件统一注册在 React 应用根元素上，这里即是截图中的 root 元素，点击右侧链接定位至源码：

<Image url={'https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/584f3dfd84b01f54.webp'} width={657} height={520} />

所有事件都经过此函数，避免时间浪费，我们加上条件，只有 input 事件才会断点：

<Image url={'https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/61c9694d8bbf1858.webp'} width={1229} height={607} />
...
<Image url={'https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/ce3def0bfe6baf45.webp'} width={590} height={96} />
