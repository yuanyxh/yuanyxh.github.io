...
author: yuanyxh
imageUrl: https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/simulate_input_in_react-logo.webp
...
![image](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/simulate_input_in_react-01.webp)
...
![image](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/simulate_input_in_react-02.webp)

但内部的状态依然未变：

![image](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/simulate_input_in_react-03.webp)
...
![image](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/simulate_input_in_react-04.webp)

React 实现了自己的合成事件系统，几乎所有的事件统一注册在 React 应用根元素上，这里即是截图中的 root 元素，点击右侧链接定位至源码：

![image](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/simulate_input_in_react-05.webp)

所有事件都经过此函数，避免时间浪费，我们加上条件，只有 input 事件才会断点：

![image](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/simulate_input_in_react-06.webp)
...
![image](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/simulate_input_in_react-07.webp)
