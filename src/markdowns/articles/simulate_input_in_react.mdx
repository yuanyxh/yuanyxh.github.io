...
author: yuanyxh
imageUrl: http://qkc148.bvimg.com/18470/2d2aae8f37b6f5b1.png
description: 记录在 React 模拟输入时产生的问题，如何解决，
---
...
<Image url={'http://qkc148.bvimg.com/18470/29f35b549d849475.png'} width={1089} height={408} />
...
<Image url={'http://qkc148.bvimg.com/18470/f2bc9721b3dba060.png'} width={380} height={72} />

但内部的状态依然未变：

<Image url={'http://qkc148.bvimg.com/18470/e26431cdb387d382.png'} width={517} height={139} />
...
<Image url={'http://qkc148.bvimg.com/18470/18859edd4a1cca9f.png'} width={1920} height={527} />

React 实现了自己的合成事件系统，几乎所有的事件统一注册在 React 应用根元素上，这里即是截图中的 root 元素，点击右侧链接定位至源码：

<Image url={'http://qkc148.bvimg.com/18470/584f3dfd84b01f54.png'} width={657} height={520} />

所有事件都经过此函数，避免时间浪费，我们加上条件，只有 input 事件才会断点：

<Image url={'http://qkc148.bvimg.com/18470/61c9694d8bbf1858.png'} width={1229} height={607} />
...
<Image url={'http://qkc148.bvimg.com/18470/ce3def0bfe6baf45.png'} width={590} height={96} />
