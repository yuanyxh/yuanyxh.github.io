...
author: yuanyxh
imageUrl: https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/serviceless_blog_establishment-logo.webp
...
![image](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/serviceless_blog_establishment-01.webp)

目前只带有简单的增删查功能，但可以在这个系统之上构建不同的文件处理程序，比如目前实现了一个在线的类 [Typora] 的 markdown 即时编辑器：

![image](https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/blog/serviceless_blog_establishment-02.webp)
