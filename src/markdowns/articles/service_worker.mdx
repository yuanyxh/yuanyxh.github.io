...
<Image url={'https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/e3f7bfe8971c0e76.webp'} width={3528} height={2060} />

<Image url={'https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/4313daf4428882ed.webp'} width={3526} height={1488} />
...
<Image url={'https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/cb497b2ab2c6e821.webp'} width={3526} height={1104} />
...
<Image url={'https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/5dcfbfd4d03f887c.webp'} width={3520} height={1816} />

为了更好的调试 sw.js，你还可以在 Console 面板中将 JavaScript 上下文切换至 service worker:

<Image url={'https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/0009f11294e68ce4.webp'} width={2002} height={1136} />
...
<Image url={'https://image-gallery-blog.oss-cn-shenzhen.aliyuncs.com/67ee82eacb55bd59.webp'} width={2440} height={1132} />
