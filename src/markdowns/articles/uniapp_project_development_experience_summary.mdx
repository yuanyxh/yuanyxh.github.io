...
<Image url='https://qkc148.bvimg.com/18470/6c1a546c851e1a75.jpg' width={1080} height={2340} alt='展示微信应用内通知的图片' />
...
<Image url='https://qkc148.bvimg.com/18470/932cf2370da9d520.gif' width={420} height={640} alt='展示自定义应用内通知的图片' />
...
<Image url='https://qkc148.bvimg.com/18470/b771ed59da0587f0.gif' width={272} height={480} alt='iOS 侧滑问题的图片' />
...
<Image url='https://qkc148.bvimg.com/18470/1608a9246b7a0b42.gif' width={380} height={640} alt='小米滑屏手势的图片' />

看起来很美好，但却与很多项目中的滑动手势冲突，比如 Element 中的滑块功能：

<Image url='https://qkc148.bvimg.com/18470/d26017b2b2503862.gif' width={380} height={640} alt='小米滑屏手势导致 element 滑块无法使用的图片' />
