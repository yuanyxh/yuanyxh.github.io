...
本章讲述了 `ES6` 的新特性，代理与反射。讲述了它们的基本使用与 `Api`、 ***捕获器不变式***，还了解了它们的不足之处，以及代理与反射可能的应用场景，比如：跟踪数据访问、隐藏属性、属性验证、数据绑定等。
...
[JS 原型与继承]: ../../posts/javascript/概念/JavaScript-概念-原型与继承.md
[ES6 中的类]: ../../posts/javascript/es6/ES6-新特性详解-类.md
[JS 闭包]: ../../posts/javascript/概念/JavaScript-概念-闭包.md
[ES6 箭头函数]: ../../posts/javascript/es6/ES6-新特性详解-箭头函数.md
