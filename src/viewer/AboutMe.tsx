  ...
  return (
    <div className={styles.aboutMe}>
      ...
      <Typography>
        ...
        <Paragraph style={{ fontSize: 16 }}>
          2020
          年因为疫情，在家躺平了一段时间，期间接触到了刷机，程序逆向，对这类知识感到好奇，开始通过培训、自学的方式学习编程，成为了一名前端。
        </Paragraph>
        ...
        <Paragraph style={{ fontSize: 16 }}>我的回答大概是：</Paragraph>

        <Paragraph style={{ fontSize: 16 }}>
          <blockquote>学一下他的设计思想，这个不会过时吧。</blockquote>
        </Paragraph>

        <Paragraph style={{ fontSize: 16 }}>现在我依旧如此认为。</Paragraph>
      </Typography>
    </div>
  );
};
