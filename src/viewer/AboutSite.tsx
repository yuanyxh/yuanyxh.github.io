    ...
    <div className={styles.aboutSite}>
      ...
      <Typography>
        ...
        <Paragraph style={{ fontSize: 16 }}>
          ...
          ，&nbsp;中间也输出了一些自己的文章，为了学习 React 也编写了一个在线演示效果的&nbsp;
          <Link
            style={{ color: 'var(--color-primary)' }}
            rel="external nofollow noopener"
          ...
          ，是为了和博客项目互补的。后来为了更好的学习 React，也为了将博客和演示站结合起来， 从 0 到
          1 搭建了目前的这个项目。
        </Paragraph>
        ...
        <Paragraph style={{ fontSize: 16 }}>
          <ul>
            ...
            <li style={{ padding: '4px' }}>
              预渲染，使用预渲染技术为每个 SPA 路由页面生成静态的 html，使程序的 SEO 更上一层楼，
              并支持静态网站托管服务下使用 history 路由。
            </li>
            <li style={{ padding: '4px' }}>
        ...
        <Paragraph style={{ fontSize: 16 }}>
          网站使用 <Text code>React</Text> + <Text code>Vite</Text> + <Text code>TypeScript</Text>
          作为基础架构，<Text code>pnpm</Text> 作为包管理器，搭配 <Text code>ESLint</Text>、
          <Text code>StyleLint</Text>、<Text code>CommitLint</Text>、<Text code>Prettier</Text>
          规范项目，<Text code>Antd</Text> 实现网站的部分 UI，图标使用{' '}
          <Text code>iconify/Material Symbols</Text> 与 <Text code>@ant-design/icons</Text>，使用{' '}
          <Text code>postcss</Text> 和 <Text code>less</Text> 处理 css，<Text code>MDX</Text> 编译
          markdown，
