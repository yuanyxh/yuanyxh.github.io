...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在上述代码中，<code>privateCounter</code> 就是一个私有变量，因为我们无法直接访问并修改它，只能通过提供的方法来访问。</p>`,50),d={href:"https://yuanyxh.com/posts/0a521b20/",target:"_blank",rel:"noopener noreferrer"},r=t('<h2 id="缺点" tabindex="-1"><a class="header-anchor" href="#缺点" aria-hidden="true">#</a> 缺点</h2><p>关于闭包的缺点，其实在 <a href="#%E5%88%9B%E5%BB%BA%E9%97%AD%E5%8C%85">创建闭包</a> 一节末尾就可窥见一斑，闭包会引用上层作用域的变量，导致上层作用域一直无法被释放，对应的内存也就不能被回收，如果大量使用闭包，可能会造成内存泄漏，解决办法也很简单，只要在不需要使用上层作用域的变量时，将变量的引用清空即可。</p><h2 id="结语" tabindex="-1"><a class="header-anchor" href="#结语" aria-hidden="true">#</a> 结语</h2><p>本文理解并讲述了闭包是什么，并就闭包的作用与注意事项进行了讨论。</p><p>内容有误请指出，内容有缺请补充。</p><h2 id="参考资料" tabindex="-1"><a class="header-anchor" href="#参考资料" aria-hidden="true">#</a> 参考资料</h2>',6),k=n("br",null,null,-1),v=n("br",null,null,-1),m={href:"https://developer.mozilla.org/zh-CN/docs/Web/JavaScript",target:"_blank",rel:"noopener noreferrer"};function b(g,f){const a=c("ExternalLinkIcon");return o(),i("div",null,[u,n("p",null,[s("关于闭包的更多运用，可以看 "),n("a",d,[s("JavaScript 概念 - 高阶函数"),e(a)]),s("，其实高阶函数的很多运用也可以看作是闭包的运用，当然依赖于闭包还能实现更多特性，读者可自行探索。")]),r,n("blockquote",null,[n("p",null,[s("《JavaScript 高级程序设计》"),k,s(" 《你不知道的 JavaScript》"),v,n("a",m,[s("MDN"),e(a)])])])])}const _=p(l,[["render",b],["__file","JavaScript-概念-闭包.html.vue"]]);export{_ as default};
