import{_ as p}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as c,c as o,a as s,b as n,d as e,e as t,r as l}from"./app.17528c88.js";const i={},u=s("h2",{id:"简述",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#简述","aria-hidden":"true"},"#"),n(" 简述")],-1),r=s("p",null,[n("文章理解并讲述 "),s("code",null,"ES6"),n(" 新特性："),s("code",null,"class"),n("。内容有误请指出，内容有缺请补充。")],-1),d=s("code",null,"ES6",-1),k=s("code",null,"JavaScript",-1),v={href:"https://yuanyxh.com/posts/5c22b54f/",target:"_blank",rel:"noopener noreferrer"},m=s("code",null,"ES6",-1),b=s("code",null,"类",-1),h=s("code",null,"JavaScript",-1),_=t('<h2 id="概念" tabindex="-1"><a class="header-anchor" href="#概念" aria-hidden="true">#</a> 概念</h2><p>类，在一些面向对象语言中是非常常见的，如 <code>java</code>、<code>c++</code> 等；类可以看作是某一类事物的抽象，泛指一组拥有相同特性相同行为的数据集合，依据某个类接口构造的具体事物称之为该类的实例，是独一无二的个体。</p><p>在早期的 <code>JavaScript</code> 中并没有类这样的特性，<code>ES6</code> 让 <code>JavaScript</code> 也拥有了类这样的语法，但 <code>JavaScript</code> 中的类与传统面向对象编程中的类是不同的，其本质还是原型与原型继承。</p><h2 id="语法" tabindex="-1"><a class="header-anchor" href="#语法" aria-hidden="true">#</a> 语法</h2><p>类可以看作是一个特殊函数，其行为与普通函数并没有太大不同。一个类主要由以下部分组成</p><ul><li>构造器</li><li>实例方法</li><li>静态方法</li><li>getter、setter 方法</li><li>私有、公有字段（实验特性）</li></ul><p>这些组成部分都不是必须的，一个空的类声明依旧被 <code>JS</code> 引擎认为是有效的。</p><h3 id="类的声明" tabindex="-1"><a class="header-anchor" href="#类的声明" aria-hidden="true">#</a> 类的声明</h3>',8),g=s("code",null,"class",-1),y=s("code",null,"class",-1),w={href:"https://yuanyxh.com/posts/a8334698/",target:"_blank",rel:"noopener noreferrer"},f=t(`<ul><li>全局作用域下声明的类不会成为 <code>window</code> 的属性</li><li>块作用域</li><li>同一作用域不能重复声明</li><li>没有声明提升</li></ul><p>同时，类中的代码都运行在严格模式下，任何严格模式下禁止的操作都会抛出错误</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 类声明</span>
...
<span class="token keyword">class</span> <span class="token class-name">Worker</span> <span class="token keyword">extends</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,26),x={href:"https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Operators/super",target:"_blank",rel:"noopener noreferrer"},j=s("code",null,"this",-1),P=s("code",null,"super",-1),S={href:"https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Classes",target:"_blank",rel:"noopener noreferrer"},J=s("h2",{id:"结语",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#结语","aria-hidden":"true"},"#"),n(" 结语")],-1),E=s("p",null,[n("文章只简要介绍了部分类语法，没有深入探究类的特性，究其原因还是因为 "),s("code",null,"JS"),n(" 中的类只是语法糖，若想深入了解 "),s("code",null,"JavaScript"),n(" 中的面向对象编程，还是应该学习并理解原型及原型继承，通过原型与原型继承能够模拟出很多模式，包括类。")],-1),N=s("h2",{id:"参考资料",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#参考资料","aria-hidden":"true"},"#"),n(" 参考资料")],-1),z=s("br",null,null,-1),C=s("br",null,null,-1),H={href:"https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/",target:"_blank",rel:"noopener noreferrer"};function W(V,B){const a=l("ExternalLinkIcon");return c(),o("div",null,[u,r,s("p",null,[n("学习 "),d,n(" 类之前请先了解 "),k,n(" 中的 "),s("a",v,[n("原型与继承"),e(a)]),n("；"),m,n(" 中的类并不是真正意义上的 "),b,n("，可以理解为对原型与原型继承的一种封装，类模式在 "),h,n(" 中是一种可选的模式，而不是必须的。")]),_,s("p",null,[n("类使用关键字 "),g,n(" 声明，"),y,n(" 关键字的特性与 "),s("a",w,[n("let/const"),e(a)]),n(" 一样")]),f,s("p",null,[n("关于 "),s("a",x,[n("super"),e(a)]),n("，虽然它会动态改变引用，但它并不代表 "),j,n("，"),P,n(" 永远指向父类或父类原型。")]),s("p",null,[n("类的其他语法规则可看 "),s("a",S,[n("MDN#Classes"),e(a)]),n("，文章只简要描述。")]),J,E,N,s("blockquote",null,[s("p",null,[n("《JavaScript 高级程序设计》"),z,n(" 《你不知道的 JavaScript》"),C,n(" _"),s("a",H,[n("MDN"),e(a)])])])])}const L=p(i,[["render",W],["__file","ES6-新特性详解-类.html.vue"]]);export{L as default};
